...
#define MSE_STATICIMMUTABLE_IMPL_INTEGRAL_SPECIALIZATION(integral_type) \
		...
		MSE_STATICIMMUTABLE_IMPL_INTEGRAL_SPECIALIZATION(int);
		MSE_STATICIMMUTABLE_IMPL_INTEGRAL_SPECIALIZATION(size_t);
#if SIZE_MAX != UINT_MAX
		MSE_STATICIMMUTABLE_IMPL_INTEGRAL_SPECIALIZATION(unsigned int);
